...
public class InternalFilesManager {
     ...
     */
    public void createDeckFile(String classSelected, String name) {
     ...
     */
    public boolean checkDuplicateDeckName(String name) {
     ...
     */
    public ArrayList<String> getDeckStatistics(String deckClass, String deckName) {
     ...
     * [V/D] [Class]
     */
    public void writeStatisticsFile(String deckClass, String deckName,
